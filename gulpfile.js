...
// Project related.
var project = 'Tagether'; // Project Name.
...
// Style related.
var styleSRC = './assets/src/scss/main.scss'; // Path to main .scss file.
var styleDestination = './assets/public/css/'; // Path to place the compiled CSS file.
// Default set to root folder.

// JS Vendor related.
var jsVendorSRC = './assets/src/js/vendor/*.js'; // Path to JS vendor folder.
var jsVendorDestination = './assets/public/js/'; // Path to place the compiled JS vendors file.
var jsVendorFile = 'vendors'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC = 'assets/src/js/main.js'; // Path to JS custom scripts folder.
var jsCustomDestination = './assets/public/js/'; // Path to place the compiled JS custom scripts file.
...
// Watch files paths.
var styleWatchFiles = './assets/src/scss/**/*.scss'; // Path to all *.scss files inside scss folder and inside them.
